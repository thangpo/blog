...
const skills = [
    ...
    { name: 'Bootstrap', icon: '<img src="https://th.bing.com/th/id/OIP.KTq5K5E3QeLVrm71FR0w8gHaHa?rs=1&pid=ImgDetMain" class="w-12 h-12 mb-3" alt="Bootstrap">', music: './music/tg10.mp3', bgIcon: '<img src="https://www.pinclipart.com/picdir/middle/35-353932_bootstrap-bootstrap-4-logo-png-clipart.png" class="w-72 h-72 opacity-40" alt="Bootstrap">' },
